...
* Изменения в переводе механики:
  ...
  * школы магии: Evocation — проявление (была эвокация);
  * заклинания: Magic Missile — Магический снаряд (была Волшебная стрела);
...
* Другие изменения:
  ...
  * монстры: automaton — автоматон (был аутоматон), beholder — созерцатель (был бехолдер), deva — дэв (был дэва), hook horror — крюкер (был крюкастый ужас), sahuagin — сахуагин (был сахваджин);
